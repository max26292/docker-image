...
CREATE TABLE `auto_checkout` (
  ...
  `cart_discount` int(11) DEFAULT NULL,
  ...
  `max_discount_percentage` int(11) DEFAULT NULL,
  ...
  `bundleProductQty` int(255) DEFAULT NULL,
...
/*Table structure for table `badge_states` */

DROP TABLE IF EXISTS `badge_states`;

CREATE TABLE `badge_states` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `badge_id_FK` FOREIGN KEY (`badge_id`) REFERENCES `badges` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `member_tabs` (
  ...
  PRIMARY KEY (`id`),
  KEY `form_id_fck` (`custom_form_id`),
  CONSTRAINT `form_id_fck` FOREIGN KEY (`custom_form_id`) REFERENCES `user_custom_field` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `member_transactions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27718 DEFAULT CHARSET=latin1;
...
CREATE TABLE `mission_users_entries` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=120555 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `missions` (
  ...
  `repeat_mission` BOOLEAN DEFAULT 0 NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `game_mission_unique_key` (`game_id`,`title`)
...
CREATE TABLE `notification_events` (
  ...
  PRIMARY KEY (`id`),
  KEY `notification_events_fk1` (`campaign_id`),
  KEY `notification_events_fk2` (`user_id`),
  CONSTRAINT `notification_events_fk1` FOREIGN KEY (`campaign_id`) REFERENCES `campaigns` (`id`) ON DELETE CASCADE,
  CONSTRAINT `notification_events_fk2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
CREATE TABLE `orders` (
  ...
  `tender_type` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `punch_cards` (
  ...
  `updated_at` datetime NOT NULL,
  `voucher_amount` varchar(255) DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
  `transaction_threshold` varchar(20) DEFAULT NULL,
  `punch_card_data` text,
  `tree_structure` text,
  `pos_ibs` int(11) DEFAULT NULL,
  `group_name` varchar(255) DEFAULT NULL,
  `businesses` text,
  `outcome_type` VARCHAR(255) DEFAULT 'voucher' NULL ,
  `points` INT(11) DEFAULT 0 NULL,
...
/*Table structure for table `saturation_report` */

DROP TABLE IF EXISTS `saturation_report`;

CREATE TABLE `saturation_report` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) DEFAULT NULL,
  `saturation_type` varchar(255) DEFAULT NULL,
  `saturation_within` varchar(255) DEFAULT NULL,
...
CREATE TABLE `stamps_completed` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12051 DEFAULT CHARSET=latin1;
...
CREATE TABLE `survey_questions` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `survey_id` bigint(11) DEFAULT NULL,
  `question` text,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE `user_addresses` (
  ...
  CONSTRAINT `user_addresses_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=90107 DEFAULT CHARSET=latin1;
...
CREATE TABLE `user_cards` (
  ...
  PRIMARY KEY (`card_id`)
) ENGINE=InnoDB AUTO_INCREMENT=110430 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_custom_field` (
  ...
  `field_type` enum('text','textarea','numerical','boolean','date','datetime','select','multiselect','form') NOT NULL,
  `field_select_values` longtext COMMENT 'Multiple select values stored as JSON doc',
  `read_only` tinyint(1) DEFAULT '0',
  `segmentable` tinyint(1) DEFAULT '1',
  `segment_name` varchar(255) NOT NULL,
  `search_name` varchar(255) NOT NULL,
  `field_unique_id` varchar(255) NOT NULL COMMENT 'For use in ES',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `parent_id` int(11) DEFAULT NULL COMMENT 'Self reference to user_custom_field',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_custom_field_compound1` (`company_id`,`field_name`),
  KEY `company_id` (`company_id`),
  KEY `field_name` (`field_name`),
  KEY `field_type` (`field_type`),
  KEY `segmentable` (`segmentable`),
  KEY `user_custom_field_venue_id` (`venue_id`),
  KEY `user_custom_field_parent_id` (`parent_id`),
  CONSTRAINT `user_custom_field_parent_id` FOREIGN KEY (`parent_id`) REFERENCES `user_custom_field` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_custom_field_venue_id` FOREIGN KEY (`venue_id`) REFERENCES `venues` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `user_custom_field_data` (
  ...
  `user_id` int(11) unsigned NOT NULL COMMENT 'Foreign key to user table',
  `value` varchar(255) DEFAULT '',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `form_id` int(11) NOT NULL DEFAULT '0',
  `form_index` int(11) NOT NULL DEFAULT '0',
  `multiselect_value` longtext COMMENT 'JSON',
  PRIMARY KEY (`id`),
  KEY `value` (`value`),
  KEY `created_at` (`created_at`),
  KEY `updated_at` (`updated_at`),
  KEY `multiselect_value` (`multiselect_value`(1000)),
  KEY `user_custom_field_data_cf_id` (`custom_field_id`),
  KEY `user_custom_field_data_user_id` (`user_id`),
  CONSTRAINT `user_custom_field_data_cf_id` FOREIGN KEY (`custom_field_id`) REFERENCES `user_custom_field` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_custom_field_data_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `user_notification` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `channel` enum('email','sms','push','post','letterbox') NOT NULL,
  `notification_type` enum('marketing','system','survey_reminder') NOT NULL DEFAULT 'system',
  `subscribed` tinyint(1) DEFAULT '1',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `channel_index` (`channel`),
  KEY `subscribed_index` (`subscribed`),
  KEY `user_notification_user_id` (`user_id`),
  CONSTRAINT `user_notification_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
CREATE TABLE `user_stamps` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `assign_through` varchar(255) DEFAULT 'Manual',
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=79785 DEFAULT CHARSET=latin1;
...
CREATE TABLE `user_venue_relation` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `user_venue_relation_user_id` (`user_id`),
  KEY `user_venue_relation_venue_id` (`venue_id`),
  KEY `user_venue_relation_created_at` (`created_at`),
  CONSTRAINT `user_venue_relation_fk1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=20366 DEFAULT CHARSET=latin1;
...
CREATE TABLE `users` (
  ...
  `address_replace` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address2_replace` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `street_number_replace` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `street_name_replace` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `suburb_replace` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `default_venue` int(11) DEFAULT NULL,
  `city_replace` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `referral_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `referal_by` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `state_replace` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `country_replace` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `user_favourites` longtext COLLATE utf8_unicode_ci,
  ...
  `profile_percentage` int(11) DEFAULT 40 NULL,
  `last_login` DATETIME  NULL,
  PRIMARY KEY (`user_id`),
  KEY `users_user_first_name` (`user_first_name`),
  KEY `users_user_family_name` (`user_family_name`),
  KEY `users_client_customer_id` (`client_customer_id`),
  KEY `users_is_active` (`is_active`),
  KEY `user_mobile` (`user_mobile`),
  KEY `email` (`email`),
  KEY `profile_index` (`profile_percentage`),
  KEY `users_email_is_active` (`email`,`is_active`),
  KEY `users_user_mobile_is_active` (`user_mobile`,`is_active`)
) ENGINE=InnoDB AUTO_INCREMENT=803819 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
/*Table structure for table `voucher_brands` */

DROP TABLE IF EXISTS `voucher_brands`;
...
CREATE TABLE `voucher_users` (
  ...
  UNIQUE KEY `voucher_code_3` (`voucher_code`),
  FULLTEXT KEY `voucher_code` (`voucher_code`)
) ENGINE=InnoDB AUTO_INCREMENT=29656 DEFAULT CHARSET=latin1;
...
CREATE TABLE `vouchers` (
  ...
  `max_redemption` double DEFAULT '0',
  ...
  `voucher_brand` int(11) DEFAULT NULL,
  `ignore_expiry` tinyint(1) DEFAULT '0',
  `voucher_setting` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `capped_amount` DOUBLE NULL,
  `voucher_timings` BOOLEAN DEFAULT 0 NULL ,
  `day_configure` TEXT NULL,
  `voucher_channel` VARCHAR(255) NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1;
...
CREATE TABLE `vc_triggers` (
  `id` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
);

CREATE TABLE `visual_campaigns` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `campaign_id` int(11) NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `vc_campaign_fk` (`campaign_id`),
  CONSTRAINT `vc_campaign_fk` FOREIGN KEY (`campaign_id`) REFERENCES `campaigns` (`id`) ON DELETE CASCADE
);
...
CREATE TABLE `survey_queue` (
  ...
  `sent_status` enum('queued','delivered','clicked','completed') NOT NULL DEFAULT 'queued',
  `meta` text,
  `csv_data` JSON NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `survey_queue_user_id_fk1` (`user_id`),
  KEY `survey_queue_survey_id_fk2` (`survey_id`),
  CONSTRAINT `survey_queue_survey_id_fk2` FOREIGN KEY (`survey_id`) REFERENCES `surveys_front` (`id`) ON DELETE CASCADE,
  CONSTRAINT `survey_queue_user_id_fk1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
);
...
CREATE TABLE `survey_reminders` (
  ...
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `reminder_queue_fk1` (`queue_id`),
  CONSTRAINT `reminder_queue_fk1` FOREIGN KEY (`queue_id`) REFERENCES `survey_queue` (`id`) ON DELETE CASCADE
);
...
CREATE TABLE `outgoing_emails` (
  ...
  CONSTRAINT `out_going_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

DROP TABLE IF EXISTS `custom_configurations`;
...
DROP TABLE IF EXISTS `user_video_status`;
CREATE TABLE `user_video_status` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `video_id` INT(10) UNSIGNED NOT NULL,
  `user_id` INT(10) UNSIGNED DEFAULT NULL,
  `status_type` ENUM('clicked','completed') DEFAULT NULL,
  `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `video_id_index` (`video_id`),
  KEY `status_type_index` (`status_type`),
  KEY `create_index` (`created_at`),
  KEY `update_index` (`updated_at`),
  KEY `user_id_index` (`user_id`),
  CONSTRAINT `user_id_fk_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  CONSTRAINT `video_id_id_fk` FOREIGN KEY (`video_id`) REFERENCES `recipe_offers` (`id`) ON DELETE CASCADE
);
CREATE TABLE `queue_ids` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `queue_id` varchar(220) DEFAULT NULL,
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `covid19` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned DEFAULT NULL,
  `number_of_guests` double DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `primary_key_index` (`id`),
  KEY `index_user_id` (`user_id`),
  KEY `index_number_of_guests` (`number_of_guests`),
  CONSTRAINT `covid19_fk_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `geo` (
  ...
  `is_in_european_union` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  FULLTEXT KEY `index_locale_code` (`locale_code`),
  FULLTEXT KEY `index_continent_code` (`continent_code`),
  FULLTEXT KEY `index_continent_name` (`continent_name`),
  FULLTEXT KEY `index_country_iso_code` (`country_iso_code`),
  FULLTEXT KEY `index_country_name` (`country_name`),
  FULLTEXT KEY `index_subdivision_1_name` (`subdivision_1_name`),
  FULLTEXT KEY `index_city_name` (`city_name`)
